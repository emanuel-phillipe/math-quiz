  ...
  return (
    <div className='flex flex-col justify-center w-full h-screen items-center'>
      ...
      <div className='flex flex-col justify-center'>
        ...
        <div className=''>
          <button onClick={() => dispatch({type: "NEW_GAME"})} className='p-4 w-full bg-zinc-700 rounded-[0.5rem] hover:bg-zinc-900 transition-all text-zinc-50 font-medium'>Reiniciar</button>
        </div>
      </div>
    </div>
  )
