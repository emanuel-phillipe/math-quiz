...
function QuizOption({title, desc, click, disabled}) {
  ...
  const classStyles = {
    div: disabled ? "bg-zinc-50 rounded-[0.5rem] p-4 w-full md:w-max transition-all cursor-not-allowed" : "bg-zinc-100 rounded-[0.5rem] p-3 px-4 w-full md:w-max hover:bg-zinc-200 transition-all cursor-pointer",
